export const prompt = async ({ prompter, args }) => {
  ...
  const staticQuestions = [
    ...
    },
    {
      ...
      message:
        'What type of component is it? This will determine the location of the component. You may select custom to add your own destination url',
      choices: [
        'Concrete',
        'Layout',
        'Smart',
  ...
  return prompter.prompt(conditionalQuestion).then((secondAnswers) => {
    return { ...firstAnswers, ...secondAnswers };
  });
};
